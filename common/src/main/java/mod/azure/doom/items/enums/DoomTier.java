...
public enum DoomTier implements Tier {
    DOOM(18, 1561, 16.0F, 3.0F, 30, () -> Ingredient.of(Services.ITEMS_HELPER.getArgentEngery())),
    DOOM_HIGHTEIR(6, 0, 16.0F, -1.9F, 30, () -> Ingredient.of(Services.ITEMS_HELPER.getArgentBlock()));
