...
public final class FabricAzureLibMod implements ModInitializer {
    ...
    public static final RecipeSerializer<GunTableRecipe> GUN_TABLE_RECIPE_SERIALIZER = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, MCDoom.modResource("gun_table"), new GunTableRecipe.Serializer());
    public static MenuType<GunTableScreenHandler> SCREEN_HANDLER_TYPE;
    public static final ResourceKey<CreativeModeTab> DoomEggItemGroup = ResourceKey.create(Registries.CREATIVE_MODE_TAB, MCDoom.modResource("eggs"));
    public static final ResourceKey<CreativeModeTab> DoomArmorItemGroup = ResourceKey.create(Registries.CREATIVE_MODE_TAB, MCDoom.modResource("armor"));
    public static final ResourceKey<CreativeModeTab> DoomBlockItemGroup = ResourceKey.create(Registries.CREATIVE_MODE_TAB, MCDoom.modResource("blocks"));
    public static final ResourceKey<CreativeModeTab> DoomWeaponItemGroup = ResourceKey.create(Registries.CREATIVE_MODE_TAB, MCDoom.modResource("weapons"));
    public static final ResourceKey<CreativeModeTab> DoomPowerUPItemGroup = ResourceKey.create(Registries.CREATIVE_MODE_TAB, MCDoom.modResource("powerup"));
    ...
    public void onInitialize() {
        ...
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, supplier, setter) -> {
            if (DoomLoot.BASTION_BRIDGE.equals(id) || DoomLoot.BASTION_HOGLIN_STABLE.equals(id) || DoomLoot.BASTION_OTHER.equals(id) || DoomLoot.BASTION_TREASURE.equals(id) || DoomLoot.NETHER_BRIDGE.equals(id) || DoomLoot.RUINED_PORTAL.equals(id) || DoomLoot.SPAWN_BONUS_CHEST.equals(id)) {
                final LootPool poolBuilder = LootPool.lootPool().setRolls(ConstantValue.exactly(1)).with(LootItem.lootTableItem(FabricDoomItems.INMORTAL).build()).with(LootItem.lootTableItem(FabricDoomItems.INVISIBLE).build()).with(LootItem.lootTableItem(FabricDoomItems.MEGA).build()).with(LootItem.lootTableItem(FabricDoomItems.POWER).build()).with(LootItem.lootTableItem(FabricDoomItems.SOULCUBE).build()).with(LootItem.lootTableItem(FabricDoomItems.DAISY).build()).build();
                supplier.pool(poolBuilder);
            }
        });
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, DoomEggItemGroup, FabricItemGroup.builder().icon(() -> new ItemStack(FabricDoomItems.IMP_SPAWN_EGG)) // icon
        ...
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, DoomArmorItemGroup, FabricItemGroup.builder().icon(() -> new ItemStack(FabricDoomItems.DOOM_HELMET)) // icon
        ...
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, DoomBlockItemGroup, FabricItemGroup.builder().icon(() -> new ItemStack(FabricDoomBlocks.BARREL_BLOCK)) // icon
        ...
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, DoomWeaponItemGroup, FabricItemGroup.builder().icon(() -> new ItemStack(FabricDoomItems.BFG_ETERNAL)) // icon
        ...
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, DoomPowerUPItemGroup, FabricItemGroup.builder().icon(() -> new ItemStack(FabricDoomItems.SOULCUBE)) // icon
