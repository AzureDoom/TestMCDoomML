...
public final class ClientListener implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        this.initMobRenders();
        MenuScreens.register(FabricAzureLibMod.SCREEN_HANDLER_TYPE, GunTableScreen::new);
    ...
    public void initItemPlacement() {
        ...
        // NonCenter
        ItemProperties.register(FabricDoomItems.SG, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.ROCKETLAUNCHER, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.PLASMAGUN, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.HEAVYCANNON, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.UNMAYKR, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.UNMAKER, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.CHAINGUN, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.BFG_ETERNAL, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.BALLISTA, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.SSG, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.PISTOL, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.DPLASMARIFLE, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.DGAUSS, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.DSG, new ResourceLocation("nocenter"), (itemStack, clientWorld, livingEntity, seed) -> nonCentered(itemStack) ? 1.0F : 0.0F);
        ItemProperties.register(FabricDoomItems.CHAINSAW, new ResourceLocation("stalled"), (itemStack, clientWorld, livingEntity, seed) -> isUsable(itemStack) ? 0.0F : 1.0F);
        ItemProperties.register(FabricDoomItems.CHAINSAW64, new ResourceLocation("stalled"), (itemStack, clientWorld, livingEntity, seed) -> isUsable(itemStack) ? 0.0F : 1.0F);
    }
}
