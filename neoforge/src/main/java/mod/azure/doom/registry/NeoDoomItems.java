...
import mod.azure.doom.NeoForgeAzureLibMod;
...
public class NeoDoomItems {
    ...
    public static final RegistryObject<Item> ARGENT_AXE = ITEMS.register("argent_axe", () -> new ArgentAxe(NeoForgeAzureLibMod.ARGENT_TIER));
    public static final RegistryObject<Item> ARGENT_HOE = ITEMS.register("argent_hoe", () -> new ArgentHoe(NeoForgeAzureLibMod.ARGENT_TIER));
    public static final RegistryObject<Item> ARGENT_PAXEL = ITEMS.register("argent_paxel", () -> new ArgentPaxel(NeoForgeAzureLibMod.ARGENT_TIER));
    public static final RegistryObject<Item> ARGENT_PICKAXE = ITEMS.register("argent_pickaxe", () -> new ArgentPickaxe(NeoForgeAzureLibMod.ARGENT_TIER));
    public static final RegistryObject<Item> ARGENT_SHOVEL = ITEMS.register("argent_shovel", () -> new ArgentShovel(NeoForgeAzureLibMod.ARGENT_TIER));
    public static final RegistryObject<Item> ARGENT_SWORD = ITEMS.register("argent_sword", () -> new ArgentSword(NeoForgeAzureLibMod.ARGENT_TIER));
